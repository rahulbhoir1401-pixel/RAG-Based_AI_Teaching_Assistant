...
#taking query from user and converting it to embeddings
incoming_query = input("Ask a question:- ")
question_embedding= create_embedding([incoming_query])[0]
# print(question_embedding)

#find similarities of question_embedding with other embeddings
#to convert embedding in 2d vector
...
print(max_indx)      
#creates array [a,b,c] in descendong order of amount of similarity(added :-1 at end to convert descending to ascending)
